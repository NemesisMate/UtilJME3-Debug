 ...
 */
public abstract class AbstractThreadedDebugStateModule extends AbstractDebugGraphStateModule {
...
//    };
    ...
    public AbstractThreadedDebugStateModule() {
        this(false);
    }

    public AbstractThreadedDebugStateModule(boolean defaultBatch) {
        super(defaultBatch);
